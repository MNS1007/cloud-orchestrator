...
direct_agent = Agent(
    ...
    instruction=(
        ...
        "2. Call visualize_tool_calls(tool_calls) to create a visual representation of the execution flow.\n"
        "3. Return both the tool plan and visualization in a user-friendly format.\n\n"
        "If build_tool_plan returns an error, stop and return the error message.\n\n"
        "**Response Format:**\n"
        "1. Brief summary of what you're setting up\n"
        "2. The visualization of the execution flow (from visualize_tool_calls)\n"
    ...
    tools=[build_tool_plan, visualize_tool_calls],
)
